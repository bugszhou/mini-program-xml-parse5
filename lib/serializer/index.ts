import { TAG_NAMES as $, NS } from "../common/html.js";
import type {
  TreeAdapter,
  TreeAdapterTypeMap,
} from "../tree-adapters/interface.js";
import {
  defaultTreeAdapter,
  type DefaultTreeAdapterMap,
} from "../tree-adapters/default.js";
...
type InternalOptions<T extends TreeAdapterTypeMap> = Required<
  SerializerOptions<T>
>;
...
function serializeNode<T extends TreeAdapterTypeMap>(
  node: T["node"],
  options: InternalOptions<T>,
): string {
...
function serializeElement<T extends TreeAdapterTypeMap>(
  node: T["element"],
  options: InternalOptions<T>,
): string {
